...
CREATE TABLE `anketa` (
  ...
  PRIMARY KEY (`fk_osoba_id`),
  CONSTRAINT `anketa_ibfk_1` FOREIGN KEY (`fk_osoba_id`) REFERENCES `osoba` (`osoba_id`) ON DELETE CASCADE
...
CREATE TABLE `predlog` (
  `fk_osoba_korisnik_id` int(11) NOT NULL,
  `fk_osoba_specialista_id` int(11) NOT NULL,
  `predlog` text DEFAULT NULL,
  PRIMARY KEY (`fk_osoba_korisnik_id`,`fk_osoba_specialista_id`),
  KEY `fk_osoba_specialista_id` (`fk_osoba_specialista_id`),
  CONSTRAINT `predlog_ibfk_1` FOREIGN KEY (`fk_osoba_korisnik_id`) REFERENCES `osoba` (`osoba_id`) ON DELETE CASCADE,
  CONSTRAINT `predlog_ibfk_2` FOREIGN KEY (`fk_osoba_specialista_id`) REFERENCES `osoba` (`osoba_id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Table structure for table `redovno_obavestavanje`
--

DROP TABLE IF EXISTS `redovno_obavestavanje`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `redovno_obavestavanje` (
  `redovno_obavestavanje_id` int(11) NOT NULL AUTO_INCREMENT,
  `fk_osoba_id` int(11) DEFAULT NULL,
  `telesna_masa` float DEFAULT NULL,
  `obim_struka` float DEFAULT NULL,
  `kcal` int(11) DEFAULT NULL,
  PRIMARY KEY (`redovno_obavestavanje_id`),
  KEY `fk_osoba_id` (`fk_osoba_id`),
  CONSTRAINT `redovno_obavestavanje_ibfk_1` FOREIGN KEY (`fk_osoba_id`) REFERENCES `osoba` (`osoba_id`) ON DELETE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `redovno_obavestavanje`
--

LOCK TABLES `redovno_obavestavanje` WRITE;
/*!40000 ALTER TABLE `redovno_obavestavanje` DISABLE KEYS */;
INSERT INTO `redovno_obavestavanje` VALUES (1,1,56,82,NULL),(2,1,58,85,1400),(3,1,56,81,NULL),(4,1,57,88,1600);
/*!40000 ALTER TABLE `redovno_obavestavanje` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2021-09-16 20:42:40
